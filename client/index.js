...
export async function search(query, { limit = 25, domains = ['peds', 'vehicles', 'weapons'] } = {}) {
  const clients = { peds, vehicles, weapons, objects, explosions, particles, animations, pedbones, vehiclebones, scenarios, vehicleweapons, walkstyles };
  const out = {};
...
export { clothing, peds, vehicles, weapons, objects, explosions, particles, animations, pedbones, vehiclebones, scenarios, vehicleweapons, walkstyles };

export default { getDomains, search, getHashes, byHash, clothing, peds, vehicles, weapons, objects, explosions, particles, animations, pedbones, vehiclebones, scenarios, vehicleweapons, walkstyles };
